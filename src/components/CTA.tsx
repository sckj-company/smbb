...
export default function CTA() {
  ...
  return (
    <section className="mt-55 -mb-30 md:w-5xl 2xl:w-7xl mx-auto bg-blue-500 rounded-3xl py-12 2xl:py-20 shadow-[0_20px_30px_rgba(15,23,42,0.08)] grid justify-center">
