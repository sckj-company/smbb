...
ALTER TABLE IF EXISTS "products" RENAME COLUMN "nameZh" TO "name_zh";
ALTER TABLE IF EXISTS "products" RENAME COLUMN "oldPrice" TO "old_price";
ALTER TABLE IF EXISTS "products" RENAME COLUMN "accentColor" TO "accent_color";
ALTER TABLE IF EXISTS "products" RENAME COLUMN "descriptionZh" TO "description_zh";
ALTER TABLE IF EXISTS "products" RENAME COLUMN "groupType" TO "group_type";
...
ALTER TABLE IF EXISTS "messages" RENAME COLUMN "createdAt" TO "created_at";
